...
class InvertedPendulum(ContinuousPyDiffGame):
   ...
   def __init__(cls,
      ...
      cls.__m_p = m_p
      cls.__p_L = p_L
      cls.__l = cls.__p_L / 2  # CoM of uniform rod
      cls.__I = 1 / 12 * cls.__m_p * cls.__p_L ** 2

      # # original linear system
      linearized_D = cls.__m_c * cls.__m_p * cls.__l ** 2 + cls.__I * (cls.__m_c + cls.__m_p)
      a21 = cls.__m_p ** 2 * PyDiffGame._g * cls.__l ** 2 / linearized_D
      a31 = cls.__m_p * PyDiffGame._g * cls.__l * (cls.__m_c + cls.__m_p) / linearized_D
      ...
      b21 = (m_p * cls.__l ** 2 + cls.__I) / linearized_D
      b31 = m_p * cls.__l / linearized_D
      b22 = b31
      ...
      cls.__origin = (0.0, 0.0)
      cls.__show_animation = show_animation
